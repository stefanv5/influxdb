...
// 10K points per key, across 4 non-overlapping TSM files.
...
// 10K points per key, across 4 overlapping TSM files. Each file has a time offset
...
// performance on the same dataset (100K keys × 10K points/key × 4 files).
